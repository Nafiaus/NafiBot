    ...
    public class TwitchBot : IDisposable
    {
        ...
        public TwitchChatMessage? Read()
        {
            ...
            while (true)
            {
                ...
                if (chatRaw.Contains("client-nonce")) // fuck nightbot no client-nonce having ass
                {
                ...
                int messageIndexStart = flags[16].IndexOf("#");
                string chatMessage = flags[16].Substring((messageIndexStart + channel.Length) + 3);
